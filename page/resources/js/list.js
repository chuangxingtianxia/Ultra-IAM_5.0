...
+function ($) {
    ...
    var listSet = {
        ...
        "columns":[
            ...
            { "data": "userId", "title": "资源名称"},
            { "data": "userName", "title": "资源IP"},
            { "data": "mobile", "title": "资源NAT前IP"},
            { "data": "userType", "title": "资源类型"},
            { "data": "status", "title": "资源状态"},
            { "data": "createUser", "title": "所属责任人"},
